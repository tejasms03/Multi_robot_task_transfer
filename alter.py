...
for x in range (1):
    ...
    print("for transfer")
    print("initial penalt without transfery=",totalpenin,"|final penalty with transfer",totalpennew,"|tasks transfered for penalty",accep1,"|tasks transferred for efficiency",accep2,"|tasks rejeted",taskc*(1+x)-accep2-accep1)
